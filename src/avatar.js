...
export default class Avatar extends Component {
    ...
    constructor(width, height, color, x, y, ctx, type, row, column, frameWidth, frameHeight, frameWidthSize, frameHeightSize, rowHeight, anime, columnLength) {
        ...
        this.animationDir = {
            p1: ["idleUp", "idleRight", "idleLeft", "idleDown", "walkRight", "walkLeft", "walkDown", "walkUp"],
            p4: ["toeTapDown", "toeTapUp", "toeTapLeft", "toeTapRight", "restArmOnSideDown", "restArmOnSideUp", "restArmOnSideLeft", "restArmOnSideRight"]
        }
    ...
    moveWithAnimation(gx, gy) {
        ...
        if (this.dir(gx, gy) === "left") {
            ...
            this.initMove(0, 5, "walkUp")
        } else if (this.dir(gx, gy) === "down") {
            this.initMove(0, 4, "walkDown")
        }
